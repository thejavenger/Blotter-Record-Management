...
public class NewCalendar {
    ...
    public NewCalendar(int month, int day, int year){
        rightNow.set(year, month, day);
    }
    
    public NewCalendar(String month, int day, int year){
        rightNow.set(year, getIntMonth(month), day);
    }
    
    public NewCalendar(Calendar set){
        rightNow = set;
    }
    
    public String adjustedCalendar(Calendar c){
        Calendar set = c;
        
        dateadjust = set;
        
        return getStringMonth(dateadjust.get(Calendar.MONTH)) + " " + dateadjust.get(Calendar.DATE) + ", " + dateadjust.get(Calendar.YEAR);
    }
    
    public String adjustedDay(int d){
        int day = d;
    ...
    public Calendar adjustedMonth(int m){
        int month = m;
    ...
    public Calendar adjustedYear(int y){
        int year = y;
